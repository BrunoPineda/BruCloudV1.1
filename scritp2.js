...
const cargarDatos = async(url) => {
    ...
    $(document).ready(function() {
        ...
        datos.data.forEach(function(name, i) {
            ...
            if (!regex.test(name)) {
                $("table").append("<tr >" +
                    "<td style='display:flex;' >  <img style='width: 30px;' src='./img/folder.png' alt='folder'> -> <a href='https://brunopineda.github.io/BruCloudV1.1/folder.html?name=" + name + "' id='BruCorp'>" + name + "<id='AdminFiltro'/a>" +
                    "</tr>");
